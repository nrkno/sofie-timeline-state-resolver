...
<a name="1.0.2"></a>
## [1.0.2](https://github.com/nrkno/tv-automation-state-timeline-resolver/compare/1.0.1...1.0.2) (2018-10-26)


### Bug Fixes

* **atem:** Attempt to fix missing commands by ensuring the correct previous state is used after makeready ([9b10156](https://github.com/nrkno/tv-automation-state-timeline-resolver/commit/9b10156))
