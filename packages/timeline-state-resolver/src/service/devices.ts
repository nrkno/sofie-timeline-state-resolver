...
import { WebSocketTcpClientDevice } from '../integrations/websocketTcpClient'
...
export const DevicesDict: Record<ImplementedServiceDeviceTypes, DeviceEntry> = {
	...
	[DeviceType.WEBSOCKET_TCP_CLIENT]: {
		deviceClass: WebSocketTcpClientDevice,
		canConnect: true,
		deviceName: (deviceId: string) => 'WebSocket TCP Client ' + deviceId,
		executionMode: () => 'sequential',
	}
}
